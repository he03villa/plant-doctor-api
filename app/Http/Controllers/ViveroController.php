...
class ViveroController extends Controller
{
     ...
     * Store owner dashboard with sales stats, chart, alerts, top products, and recent invoices
     */
    #[OA\Get(
        ...
        parameters: [
            new OA\Parameter(
                ...
                in: 'query',
                required: false,
                schema: new OA\Schema(type: 'string', enum: ['today', 'week', 'month', 'year'], default: 'today'),
                description: 'Period for summary stats and top products'
            ),
            new OA\Parameter(
    ...
    public function dashboard(Request $request): JsonResponse
    {
        try {
            ...
            $data = $this->dashboardService->getDashboard($store, $period, $lowStockThreshold);
